...
> The bill art shipped before 2026-08-18 was a third-party illustration used
> with a credit line but **no license grant**, and it depicted a real person.
> It was replaced with the generated artwork below; the generator is committed
> so the art stays reproducible and its provenance stays checkable.
...
| Bill artwork (`wallet-core/assets/bill_template.png`, `assets/templates/*.png`) | Original work, generated by `wallet-core/assets/art/generate_bill_art.py` — guilloche from hypotrochoid curves, lettering set in the DejaVu fonts above. No third-party artwork. |
